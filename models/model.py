...
class VideoNet3D(nn.Module):
    def __init__(self, num_classes=2,model_type="resnet",fea_dim=20):
        ...
        self.pool = torch.nn.AdaptiveAvgPool1d(fea_dim)

        self.mlp = MLPClassifier(input_dim=fea_dim, hidden_dim=(fea_dim+num_classes)//2,output_dim=num_classes)
...
if __name__ =="__main__":
    ...
    for model_type in model_types:
        model = VideoNet3D(num_classes=2,model_type=model_type)
